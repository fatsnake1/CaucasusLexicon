...
const localization = {
  ...
  'ka': {
    ...
    'steward-desc': 'კავკასიური ლექსიკონი 2026 წელს შეიქმნა. პროექტის ავტორი მიხეილ ჟურულია. ინფორმაცია კავკასიური მემკვიდრეობის შესახებ საკმაოდ მიუწვდომელია. ენის ბარიერები, ძველი წყაროები და ამ სფეროს ფრაგმენტულობა ძალიან დიდ დაბრკოლებებს წარმოადგენს. ამ ღია პლატფორმის მიზანი საკმაოდ დიდი მასშტაბის ინფორმაციის ცენტრალიზებაა. იმედა სამომავლოდ ეს პროექტი გაიზრდება და სხვა მკვლევარები შემოგვიერთდებიან არქივის ქმნილებაში.',
